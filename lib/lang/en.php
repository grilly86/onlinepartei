...
class Lang
{
	var $languageArray=array(
		...
		"holdShiftToBreak"=>"Press and hold the Shift-key (&uArr;) while pressing enter (&crarr;) to insert a line break. Use <a target=\"_blank\" href=\"markdown.html\">Markdown</a> for formatting.",
		"holdShiftToBreak_nolink"=>"Press and hold the Shift-key (&uArr;) while pressing enter (&crarr;) to insert a line break. Use Markdown for formatting.",
		...
		"noDbConnection"=>"The database connection could not be established.",
		"newTag"=>"New tag",
